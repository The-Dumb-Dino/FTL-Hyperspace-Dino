...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::SetFlag", typeid(void (AchievementTracker::*)(const std::string &)), ".4157", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::GetFlagValue", typeid(int (AchievementTracker::*)(const std::string &)), ".4157", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("AchievementTracker::GetFlag", typeid(bool (AchievementTracker::*)(const std::string &)), ".4157", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CFPS::GetUnpausedTime", typeid(float (CFPS::*)()), ".f30f1007", nullptr, 0, 32, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewCustomizeBox::MouseClick", typeid(void (CrewCustomizeBox::*)()), ".55534889fb4883ec4880bf3804000000744e80bf9004000000", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("CrewCustomizeBox::SetCustomizeMode", typeid(void (CrewCustomizeBox::*)(Point )), ".415541544989f455534889fb4883ec68c6873804000001", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("ShipManager::CheckDlcEnabled", typeid(void (ShipManager::*)()), ".4157415641554154", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("Spreader_Fire::StartInRoom", typeid(bool (Spreader_Fire::*)(int , int )), "41574989ff4156415541545589f55389d34883", nullptr, 0, 0, &func);
}
...
{
    static void *func = 0;
	static FunctionDefinition funcObj("WorldManager::PossibleDamage", typeid(int (WorldManager::*)(EventDamage )), ".4155", nullptr, 0, 0, &func);
}
